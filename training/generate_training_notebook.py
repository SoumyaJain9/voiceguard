...
def generate_notebook(output_file: str = "training_notebook.ipynb"):
    """
    Generates a clean, presentation-ready Jupyter Notebook for Google Colab / Kaggle 
    to train and evaluate the VoxGuard Deepfake Audio Detection Model.
    """
    cells = [
        {
            "cell_type": "markdown",
...
if __name__ == "__main__":
    generate_notebook("training_notebook.ipynb")
